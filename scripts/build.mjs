...
for (const name of ['index.html','styles.css','app.js','engine.js','sprites.js','icon.svg','manifest.webmanifest']) await copyFile(name,`dist/${name}`);
await writeFile('dist/version.json',JSON.stringify({app:'tamago2',release:RELEASE})+'\n');
console.log('Built tamago2:',RELEASE,'(8 public files)');
